...
pgn_path = "simulated_filtered_modelV2(transfer_learning_original)/TL_test.pgn"
output_csv = "simulated_filtered_modelV2(transfer_learning_original)/TL_test.csv"
